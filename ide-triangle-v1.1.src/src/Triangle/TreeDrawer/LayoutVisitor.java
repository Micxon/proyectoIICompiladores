...
public class LayoutVisitor implements Visitor {
  ...
  public Object visitRepeatUntilDoCommand(RepeatUntilDoCommand ast, Object o) {
    return layoutBinary("RepeatUntilDoCom.", ast.E, ast.C);
  }

  public Object visitRepeatWhileDoCommand(RepeatWhileDoCommand ast, Object o) {
    return layoutBinary("RepeatWhileDoCom.", ast.E, ast.C);
  }
  
  public Object visitRepeatForRangeDo(RepeatForRangeDo ast, Object o) {
    return layoutTernary("RepeatForRangeDo", ast.R, ast.E, ast.C);
  }

  public Object visitRepeatForRangeWhile(RepeatForRangeWhile ast, Object o) {
    return layoutQuaternary("RepeatForRangeWhile.", ast.R, ast.E1, ast.C, ast.E2);
  }

  public Object visitRepeatForRangeUntil(RepeatForRangeUntil ast, Object o) {
    return layoutQuaternary("RepeatForRangeUntil.", ast.R, ast.E1, ast.C, ast.E2);
  }

  public Object visitRepeatForIn(RepeatForIn ast, Object o) {
    return layoutBinary("RepeatForIn.", ast.R, ast.C);
  }

  public Object visitPartialIfCommand(PartialIfCommand ast, Object o) {
      return layoutBinary("PartIfComm.", ast.E, ast.C);
  }

  public Object visitSequentialIfCommand(SequentialIfCommand ast, Object o) {
      return layoutBinary("SequentialIfComm.", ast.C1, ast.C2);
  }
  // </editor-fold>
  ...
  public Object visitRecursiveProcFuncs(RecursiveProcFuncs ast, Object o) {
    return layoutUnary("RecProcFuncs.", ast.D1);
  }
  ...
  public Object visitCompoundSingleDeclaration(CompoundSingleDeclaration ast, Object o) {
    return layoutUnary("CompSingDecl.", ast.D);
  }

  public Object visitSequentialProcFunc(SequentialProcFunc ast, Object o) {
    return layoutBinary("SeqProcFunc.", ast.D1, ast.D2);
  }
  // </editor-fold>
