...
public class TreeVisitor implements Visitor {
    ...
    public Object visitRepeatForRangeDo(RepeatForRangeDo ast, Object obj){ //Metodo nuevo
        return (createTernary("Repeat For Range Do", ast.R, ast.E, ast.C));
    }
    
    public Object visitRepeatForRangeWhile(RepeatForRangeWhile ast, Object obj){ //Metodo nuevo
        return (createQuaternary("Repeat For Range While", ast.R, ast.E1, ast.C, ast.E2));
    }
    
    public Object visitRepeatForRangeUntil(RepeatForRangeUntil ast, Object obj){
        return (createQuaternary("Repeat For Range Until", ast.R, ast.E1, ast.C, ast.E2));
    }
    
    public Object visitRepeatForIn(RepeatForIn ast, Object obj){
        return (createBinary("Repeat For In", ast.R, ast.C));
    }

    public Object visitPartialIfCommand(PartialIfCommand ast, Object o) {
        return (createBinary("Partial If Command", ast.E, ast.C));
    }

    public Object visitSequentialIfCommand(SequentialIfCommand ast, Object o) {
        return (createBinary("Sequential If Command", ast.C1, ast.C2));
    }
    // </editor-fold>
    ...
    public Object visitVarInitDeclaration(VarInitDeclaration ast, Object obj) {
        return(createBinary("Init Variable Declaration", ast.I, ast.E));
    }
    ...
    public Object visitInVarDecl(InVarDecl ast, Object obj) {
        return (createBinary("In Variable Declaration", ast.I, ast.E));
    }

    public Object visitRecursiveProcFuncs(RecursiveProcFuncs ast, Object o) {
        return (createUnary("Recursive Proc-Func", ast.D1));
    }
    ...
    public Object visitCompoundSingleDeclaration(CompoundSingleDeclaration ast, Object o) {
        return (createUnary("CompoundSingleDeclaration", ast.D));
    }

    public Object visitSequentialProcFunc(SequentialProcFunc ast, Object o) {
        return (createBinary("Sequential Proc-Func", ast.D1, ast.D2));
    }
    // </editor-fold>
